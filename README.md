# Hey, You. You're Finally Awake - A Permadeath Mod.

SKSE plugin that makes you wake up on the cart every time you die.
...
## Building
```
git clone https://github.com/powerof3/HeyYouYoureFinallyAwake
cd HeyYouYoureFinallyAwake
